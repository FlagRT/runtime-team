...
> 状态：🔄 **进行中**（阶段 0–4 已全部完成 ✅；**官方 `-base` 镜像等价性验证已完成**；阶段 5 收敛待执行，见 §6）
...
| `docs/KUNLUN_P800_BASE_IMAGE_EQUIVALENCE_20260920.md` | **官方 `-base` 镜像等价性验证报告**：全部结论复现对照（逐用例/逐 `detail`）、**KL3 挂死一致重现**、**`-base` 开箱缺 `triton` 的调用链与补齐命令**、对镜像入锁的建议 |
